 ...
 * 
 * @pre wifi_init() or wifi_initWithConfig() should be called before calling this API
 * @see wifi_connectEndpoint_callback_register(), wifi_disconnectEndpoint_callback
 */
 ...
 * 
 * @pre wifi_init() or wifi_initWithConfig() should be called before calling this API
 * @see wifi_disconnectEndpoint_callback_register(), wifi_connectEndpoint_callback
 */
